        ...
        <div class="header-container" style="display: flex;justify-content: space-between;padding: 0 16px">
            ...
            <div class="right d-flex">
                <div class="search d-flex">
                    ...
                    <button class="btn btn-primary search-btn mx-1" type="button" onclick="searchGroup();"><i class="bi bi-search"></i></button>
                </div>
                <div class="avatar"
                     style="width: 36px; height: 36px; border-radius: 50%;background-color: #909090; display: flex !important; justify-content: center; align-items: center;">
                    <svg focusable="false"
                         aria-hidden="true" viewBox="0 0 24 24" data-testid="PersonIcon" width="28px" height="28px"
                         fill="#fff">
